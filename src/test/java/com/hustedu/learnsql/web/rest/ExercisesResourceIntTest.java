...
import com.hustedu.learnsql.repository.search.ExercisesSearchRepositoryMockConfiguration;
import com.hustedu.learnsql.LearnSqlApp;

import com.hustedu.learnsql.domain.Exercises;
import com.hustedu.learnsql.repository.ExercisesRepository;
import com.hustedu.learnsql.repository.search.ExercisesSearchRepository;
import com.hustedu.learnsql.service.ExercisesService;
import com.hustedu.learnsql.service.dto.ExercisesDTO;
import com.hustedu.learnsql.service.mapper.ExercisesMapper;
...
public class ExercisesResourceIntTest {
     ...
     *
     * @see ExercisesSearchRepositoryMockConfiguration
     */
    @Autowired
...
//            .updatedBy(DEFAULT_UPDATED_BY);
    ...
    public void createExercises() throws Exception {
        ...
        assertThat(testExercises.getLastModifiedDate()).isEqualTo(DEFAULT_UPDATED_DATE);
        assertThat(testExercises.getLastModifiedBy()).isEqualTo(DEFAULT_UPDATED_BY);
    ...
    public void checkUpdatedDateIsRequired() throws Exception {
        int databaseSizeBeforeTest = exercisesRepository.findAll().size();
        // set the field null
        exercises.setLastModifiedDate(null);
    ...
    public void checkUpdatedByIsRequired() throws Exception {
        int databaseSizeBeforeTest = exercisesRepository.findAll().size();
        // set the field null
        exercises.setLastModifiedBy(null);
...
//            .updatedBy(UPDATED_UPDATED_BY);
        ...
        assertThat(testExercises.getLastModifiedDate()).isEqualTo(UPDATED_UPDATED_DATE);
        assertThat(testExercises.getLastModifiedBy()).isEqualTo(UPDATED_UPDATED_BY);
