...
import com.hustedu.learnsql.repository.search.CategorySearchRepositoryMockConfiguration;
import com.hustedu.learnsql.LearnSqlApp;

import com.hustedu.learnsql.domain.Category;
import com.hustedu.learnsql.repository.CategoryRepository;
import com.hustedu.learnsql.repository.search.CategorySearchRepository;
import com.hustedu.learnsql.service.CategoryService;
import com.hustedu.learnsql.service.dto.CategoryDTO;
import com.hustedu.learnsql.service.mapper.CategoryMapper;
...
public class CategoryResourceIntTest {
    ...
    private static final Boolean DEFAULT_IS_KEYWORD = false;
    private static final Boolean UPDATED_IS_KEYWORD = true;

    private static final String DEFAULT_DESCRIPTION = "AAAAAAAAAA";
    private static final String UPDATED_DESCRIPTION = "BBBBBBBBBB";

    private static final String DEFAULT_NAME_TABLE_DATA = "AAAAAAAAAA";
    private static final String UPDATED_NAME_TABLE_DATA = "BBBBBBBBBB";
     ...
     *
     * @see CategorySearchRepositoryMockConfiguration
     */
    @Autowired
...
//            .updatedBy(DEFAULT_UPDATED_BY);
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.isIsKeyword()).isEqualTo(DEFAULT_IS_KEYWORD);
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isKeyword").value(hasItem(DEFAULT_IS_KEYWORD.booleanValue())))
            .andExpect(jsonPath("$.[*].description").value(hasItem(DEFAULT_DESCRIPTION.toString())))
            .andExpect(jsonPath("$.[*].nameTableData").value(hasItem(DEFAULT_NAME_TABLE_DATA.toString())))
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.isKeyword").value(DEFAULT_IS_KEYWORD.booleanValue()))
            .andExpect(jsonPath("$.description").value(DEFAULT_DESCRIPTION.toString()))
            .andExpect(jsonPath("$.nameTableData").value(DEFAULT_NAME_TABLE_DATA.toString()))
...
//            .updatedBy(UPDATED_UPDATED_BY);
        ...
        assertThat(testCategory.isIsKeyword()).isEqualTo(UPDATED_IS_KEYWORD);
    ...
    public void searchCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/_search/categories?query=id:" + category.getId()))
            ...
            .andExpect(jsonPath("$.[*].nameTableData").value(hasItem(DEFAULT_NAME_TABLE_DATA)))
            .andExpect(jsonPath("$.[*].createdDate").value(hasItem(DEFAULT_CREATED_DATE.toString())))
            .andExpect(jsonPath("$.[*].createdBy").value(hasItem(DEFAULT_CREATED_BY)))
            .andExpect(jsonPath("$.[*].updatedDate").value(hasItem(DEFAULT_UPDATED_DATE.toString())))
            .andExpect(jsonPath("$.[*].updatedBy").value(hasItem(DEFAULT_UPDATED_BY)));
